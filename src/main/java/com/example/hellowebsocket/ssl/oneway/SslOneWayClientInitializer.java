...
public class SslOneWayClientInitializer extends ChannelInitializer<SocketChannel> {
	...
	protected void initChannel(SocketChannel ch) throws Exception {
		...
		String cChatPath =  "/Users/Scarlett/IdeaProjects/netty-sample/src/main/java/com/example/hellowebsocket/ssl/conf/clientStore.jks";
		
		SSLEngine engine = SslContextFactory.getClientContext(cChatPath)
