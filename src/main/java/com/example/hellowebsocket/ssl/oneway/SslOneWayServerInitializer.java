...
public class SslOneWayServerInitializer extends ChannelInitializer<SocketChannel> {
	...
	protected void initChannel(SocketChannel sc) throws Exception {
		...
		String sChatPath = "/Users/Scarlett/IdeaProjects/netty-sample/src/main/java/com/example/hellowebsocket/ssl/conf/serverStore.jks";
		
		SSLEngine engine = SslContextFactory.getServerContext(sChatPath).createSSLEngine();
